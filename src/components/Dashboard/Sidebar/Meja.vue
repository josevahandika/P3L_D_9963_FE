            ...
            <v-row>
              ...
              <v-col>
                <v-btn
                  ...
                  dark
                  @click="dialog = true"
                  v-if="yanglogin === 'Operational Manager'"
                >
                  Tambah
                </v-btn>
              ...
              <v-col v-for="(item, i) in props.items" :key="i" md="3">
                <v-expand-x-transition>
                  <v-card
                    ...
                    color="success"
                  >
                    <v-list-item-title class="headline mb-5; white--text">
                      <b> {{ item.nomor_meja }}</b>
                    </v-list-item-title>
                    <v-card-actions
                      ...
                      v-if="yanglogin === 'Operational Manager'"
                    >
                      <v-icon color="white" small @click="editHandler(item)">
                        mdi-pencil
                      </v-icon>
                      <v-icon color="white" small @click="deleteHandler(item)">
                        mdi-delete
                      </v-icon>
                    </v-card-actions>
                  </v-card>
...
export default {
  ...
  data() {
    return {
      ...
      fieldEmpty: [
        ...
        (v) => (v && v > 0) || "Nomor Meja tidak boleh kurang dari 0",
      ],
      valid: true,
  ...
  methods: {
    ...
    editHandler(item) {
      this.inputType = "Ubah";
      let temp = this.tempProducts.find(
        (meja) => meja.nomor_meja === item.nomor_meja
      ).id;
      this.editId = temp;
